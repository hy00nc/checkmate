...
def extract_params():
    ...
    parser.add_argument('--platform', default="elsa", choices=PLATFORM_CHOICES)
...
#                              show_layer_names=True)
    ...
    param_dict = {'LogToConsole': 1,
                  'LogFilae': str(log_base / f"max_bs_{model_name}.solve.log"),
                  'Threads': args.num_threads,
                  'TimeLimit': math.inf}
    ilp_solver = MaxBatchILPSolver(g, budget=platform_ram - g.cost_ram_fixed, gurobi_params=param_dict, cpu_fwd_factor=2)
